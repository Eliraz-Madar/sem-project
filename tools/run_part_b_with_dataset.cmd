...
echo ========================================
echo Running Document Classification with Custom Dataset
echo ========================================
echo.
...
echo.
echo ========================================
echo Converting dataset.csv to JSONL format
echo ========================================
echo.

python scripts\convert_dataset_csv_to_jsonl.py
if errorlevel 1 (
    echo [ERROR] Failed to convert dataset.csv to JSONL format.
    echo Make sure dataset.csv exists in the root directory.
    exit /b 1
)
